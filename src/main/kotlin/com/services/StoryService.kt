...
class StoryService {
    ...
    suspend fun createStory(request: CreateStoryRequest, ownerId: String): Story {
    ...
    suspend fun getUserStories(ownerId: String, page: Int, limit: Int): Pair<List<Story>, Long> {
    ...
    suspend fun deleteStory(id: String, ownerId: String): Boolean {
