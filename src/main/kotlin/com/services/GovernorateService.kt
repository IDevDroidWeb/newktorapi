...
class GovernorateService {
    ...
    suspend fun createGovernorate(countryId: String, nameAr: String, nameEn: String): Governorate {
    ...
    suspend fun getGovernorateById(id: String): Governorate {
        return governorateRepository.findById(id)
            ?: throw NoSuchElementException("Governorate not found")
    }

    suspend fun getGovernoratesByCountry(countryId: String): List<Governorate> {
    ...
    suspend fun updateGovernorate(id: String, updates: Map<String, Any>): Governorate {
    ...
    suspend fun deleteGovernorate(id: String): Boolean {
