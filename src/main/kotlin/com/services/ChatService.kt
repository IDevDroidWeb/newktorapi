...
class ChatService {
    ...
    suspend fun createOrGetChat(senderId: String, receiverId: String): Chat {
    ...
    suspend fun getChatById(id: String, userId: String): Chat {
    ...
    suspend fun getUserChats(userId: String, page: Int, limit: Int): Pair<List<Chat>, Long> {
    ...
    suspend fun sendMessage(chatId: String, senderId: String, request: SendMessageRequest): Message {
