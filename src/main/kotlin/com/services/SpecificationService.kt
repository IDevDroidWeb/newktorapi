...
class SpecificationService {
    ...
    suspend fun getSpecificationById(id: String): Specification {
    ...
    suspend fun updateSpecification(id: String, updates: Map<String, Any>): Specification {
    ...
    suspend fun deleteSpecification(id: String): Boolean {
