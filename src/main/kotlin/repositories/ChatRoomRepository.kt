...
class ChatRoomRepository {
    ...
    suspend fun findById(id: ObjectId): ChatRoom? {
        return collection.find(Filters.eq("_id", id)).firstOrNull()
    }

    suspend fun addMessage(roomId: ObjectId, message: Message): Boolean {
    ...
    suspend fun markMessagesAsRead(roomId: ObjectId, senderId: ObjectId): Boolean {
