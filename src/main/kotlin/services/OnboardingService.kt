...
class OnboardingService {
    ...
    suspend fun getOnboardingById(id: ObjectId): Onboarding {
    ...
    suspend fun updateOnboarding(id: ObjectId, updates: Map<String, Any>): Onboarding {
    ...
    suspend fun deleteOnboarding(id: ObjectId): Boolean {
