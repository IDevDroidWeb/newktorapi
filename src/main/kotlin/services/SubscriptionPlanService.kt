...
class SubscriptionPlanService {
    ...
    suspend fun getPlanById(id: ObjectId): SubscriptionPlan {
    ...
    suspend fun updatePlan(id: ObjectId, updates: Map<String, Any>): SubscriptionPlan {
    ...
    suspend fun deletePlan(id: ObjectId): Boolean {
